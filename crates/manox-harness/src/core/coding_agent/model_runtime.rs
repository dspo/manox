...
use crate::core::provider::anthropic::AnthropicStreamFn;
use crate::core::provider::openai::completions::CompletionsStreamFn;
...
impl ModelRuntime {
    ...
    pub fn with_provider_registry(
        registry: Arc<crate::core::provider_registry::ProviderRegistry>,
    ) -> Self {
