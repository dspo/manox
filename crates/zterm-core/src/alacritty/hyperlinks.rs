...
mod tests {
    ...
    /// Default path hyperlink regexes, mirroring what user settings would provide.
    const DEFAULT_PATH_HYPERLINK_REGEXES: [&str; 2] = [
            ...
            pub fn find_from_grid_point_bench(
                ...
                thread_local! {
                    static TEST_REGEX_SEARCHES: RefCell<RegexSearches> =
                        RefCell::new(RegexSearches::new(
                            DEFAULT_PATH_HYPERLINK_REGEXES,
                            PATH_HYPERLINK_TIMEOUT,
                        ));
                }
        ...
        thread_local! {
            static TEST_REGEX_SEARCHES: RefCell<RegexSearches> =
                RefCell::new(RegexSearches::new(
                    ...
                    .into_iter()
                    .chain(DEFAULT_PATH_HYPERLINK_REGEXES),
                    PATH_HYPERLINK_TIMEOUT,
                ));
        }
