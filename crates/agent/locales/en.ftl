...
workspace-plan-approval-title = Plan submitted for approval
workspace-plan-approval-question = Approving exits plan mode and begins execution. Rejecting ends this turn and stays in plan mode — your next message becomes the revised direction.
workspace-plan-continue = Reject and end turn
