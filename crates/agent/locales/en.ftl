...
settings-models-file-caption = Provider config file: {$path}
...
settings-models-saved = Provider config saved
...
settings-models-count = {$models} models · {$endpoints} endpoints
settings-models-load-error-title = Config load failed
settings-models-load-error-hint = Saving is disabled so the unrecognized file is not overwritten. Fix the file or reload.
settings-models-row-name = Name
settings-models-ph-name = Provider display name
settings-models-row-apikey = API key source
settings-models-ph-apikey = keychain:SERVICE · env:VAR · literal:VALUE · $(shell command)
settings-models-section-endpoints = Endpoints
settings-models-row-url = URL
settings-models-ph-url = https://api.example.com
settings-models-row-agents = Visible agents
settings-models-ph-agents = Comma-separated, empty = all agents
...
settings-models-add-env = Add variable
settings-models-section-models = Models
settings-models-mode-inline = Inline
settings-models-mode-remote = Remote URL
...
settings-models-row-wire-apis = Wire APIs
