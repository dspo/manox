...
//! it into a [`agent::prompt::MainSystemPromptData`]. The layout — section
...
//! ([`agent::language::Language`]); this module renders the main-thread head,
