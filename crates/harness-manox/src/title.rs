...
pub fn build_title_request(
    ...
    req_messages.push(LanguageModelRequestMessage {
        ...
        content: vec![MessageContent::Text(
            agent::prompt::render_static(
                agent::prompt::PromptTemplate::TitleFirstInstruction,
                lang,
            )
    ...
    LanguageModelRequest {
        ...
        reasoning_effort: agent::settings::side_call_effort(
            &crate::settings_ext::side_calls().title_policy(),
...
pub fn build_topic_shift_request(
    ...
    let instruction = agent::prompt::render(
        agent::prompt::PromptTemplate::TitleTopicShiftInstruction,
        lang,
        &agent::prompt::TopicShiftData {
...
mod tests {
    ...
    fn build_request_shape() {
        ...
        let req = build_title_request(&messages, agent::language::Language::En);
    ...
    fn last_user_text_skips_tool_result_user_messages() {
        ...
        let req = build_topic_shift_request("旧话题", &messages, agent::language::Language::En);
    ...
    fn build_topic_shift_request_shape() {
        ...
        let req = build_topic_shift_request("旧话题标题", &messages, agent::language::Language::En);
        assert!(req.tools.is_empty());
        assert_eq!(req.messages.len(), 3);
    ...
    fn title_sampling_ignores_internal_goal_and_external_event_messages() {
        ...
        let req = build_topic_shift_request("current", &messages, agent::language::Language::En);
