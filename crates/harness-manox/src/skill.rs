...
impl SkillRegistry {
    ...
    pub fn summaries(&self) -> Vec<agent::prompt::SkillSummaryPromptData> {
        self.skills
            .iter()
            .map(|(key, s)| agent::prompt::SkillSummaryPromptData {
                name: key.clone(),
...
pub fn summaries_or_empty() -> Vec<agent::prompt::SkillSummaryPromptData> {
