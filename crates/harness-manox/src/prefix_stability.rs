...
mod tests {
    ...
    fn tool(name: &str) -> crate::language_model::LanguageModelRequestTool {
        crate::language_model::LanguageModelRequestTool {
            name: name.into(),
    ...
    fn system_msg(text: &str) -> LanguageModelRequestMessage {
        LanguageModelRequestMessage {
            role: Role::System,
    ...
    fn request_with_instructions() -> LanguageModelRequest {
        ...
        let instructions =
            crate::collaboration_mode::unified_instructions(agent::language::Language::En);
