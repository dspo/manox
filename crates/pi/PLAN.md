...
**基线（S0 冻结，S8–S10 复核轮确认）：** Rust HEAD `efa8ae0`（S8–S16 复核轮修复已提交）；TS Pi 冻结 `4488ad55c18f07ae89a489096c90de8667b3adfb`（upstream 已推进至 `b9d360a2c`，新增仅 Google adapters transient retry（未选 provider breadth））。
