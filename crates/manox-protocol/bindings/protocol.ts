 ...
 */
model: JsonValue | null, permissionMode: string, reasoningEffort: string, pinned: boolean, archived: boolean, depth: number, agentLabel: string, selfAuthor: string, worktreeActive: boolean, worktreePath: string | null, branch: string | null, goal: JsonValue | null, goalElapsedSeconds: bigint | null, planMode: boolean, browserSuites: Array<string>, historyPhase: string, running: boolean, hasInteracted: boolean, };
