...
# vscode/dist). The bundle is checked into the repo for the browser host
...
# 1. Webview bundle + staging under vscode/dist (the host loads it from
...
mkdir -p "$ROOT/vscode/dist/webview"
cp -f dist/webview/bundle.js dist/webview/bundle.css "$ROOT/vscode/dist/webview/"
